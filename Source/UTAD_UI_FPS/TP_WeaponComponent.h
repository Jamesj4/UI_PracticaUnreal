...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnBulletsChangedSignature,int,CurrentNumBullets);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FONDetectingEnemy, bool , bIsOnTarget);
...
public:
	...
	FOnShootSignature FOnShoot;

	UPROPERTY(BlueprintAssignable, Category = "Weapon")
	FOnBulletsChangedSignature OnAmmoChanged;

	UPROPERTY(BlueprintAssignable, Category = "Weapon")
	FONDetectingEnemy ONDetectingEnemy;
...
private:
	...
	UPROPERTY()
	APlayerController* PlayerControllerMain;
